...
|---|---|---|
| `79e3a8e34` | `BaseSpawner.Dto.cs`: `private protected` DTO helpers â†’ `protected` | `ModernSpawner.ToDto()` lives in another assembly and needs `DtoName`, `DtoWalkingRange`, `DtoSpawnPositionMode`, `DtoMaxSpawnAttempts`, `DtoHomeRange`, `BoundsFromHomeRange`. |
